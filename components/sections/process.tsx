  ...
  return (
    <AnimatedSection id="process" className="px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 rounded-[2rem] border border-accent/30 bg-gradient-to-r from-accent/12 via-primary/10 to-accent/12 p-6 text-center shadow-[0_18px_48px_rgba(155,225,93,0.08)]">
